<template>
  <n-space vertical>
    ...
    <!-- 上传组件 -->
    <n-upload action="https://upload.liuzihao1997.workers.dev/upload" name="file" :data="extraData" accept="*/*"
      ...
      <n-upload-dragger>
        <div style="font-size: 16px">
          ...
          <n-icon size="48" :depth="3">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 36 36">
              <path fill="#DE2910" d="M36 27a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4V9a4 4 0 0 1 4-4h28a4 4 0 0 1 4 4z" />
              <path fill="#FFDE02"
        ...
        <n-p depth="3" style="margin: 8px 0 0 0">
          English to Chinese Digital Stamp in PNG format
        </n-p>
      </n-upload-dragger>
    </n-upload>
  </n-space>
...
const customFilename = ref(`${props.alias}toCn.png`);  // 自定义文件名
